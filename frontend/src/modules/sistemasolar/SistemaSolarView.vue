...
const tabs = [
  ...
  },
  {
    ...
    endpoint: "/ssd/cad",
    key: "data",
    fields: ["des", "cd", "dist", "dist-min", "v-rel", "h", "body"],
  },
  {
    id: "sentry",
    label: "Risco de Impacto",
    endpoint: "/ssd/sentry",
    key: "data",
    fields: ["des", "fullname", "ip", "ps_max", "last_obs", "v_inf"],
  },
  {
    id: "nhats",
    label: "NHATS",
  ...
  <div class="min-h-full px-10 py-8 text-white">
    <header class="mb-8">
      ...
      <p class="text-sm text-white/40">
        Dados de bolas de fogo, aproximações e riscos de impacto via NASA
        SSD/CNEOS.
      </p>
    </header>
    ...
    <div v-else class="rounded-xl border border-white/[0.08] overflow-x-auto">
      <table class="w-full text-xs">
        <thead>
          <tr
            class="border-b border-white/[0.08] text-left text-white/40 uppercase tracking-wider"
          >
            <th
