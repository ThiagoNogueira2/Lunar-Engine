  ...
  <div class="min-h-full px-10 py-8 text-white">
    <header class="mb-8">
      ...
      <p class="text-sm text-white/40">
        Catálogo de exoplanetas via NASA Exoplanet Archive.
      </p>
    </header>
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-5 py-3.5 text-xs">
                <span
                  class="px-2 py-0.5 rounded bg-purple-500/10 text-purple-300 border border-purple-500/20"
                >
                  {{ p.discoverymethod ?? "—" }}
                </span>
              </td>
              <td
                class="px-5 py-3.5 text-right text-white/60 font-mono text-xs"
              >
                {{ fmt(p.pl_orbper, 3) }}
              </td>
              <td
